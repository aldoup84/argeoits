...
public class GuardarDatos {
	...
	private int correctos, errores, puntos, nivel, idSesion;
    private double tiempo;

   
    public GuardarDatos(string ejercicio, int idSesion, int correctos, int errores, int puntos, double tiempo, int nivel, string dificultad)
    {
    ...
    {   
        ...
        dbCmd.CommandText = "INSERT INTO EJERCICIOS (folio, idSesion, idEjercicio, idUsuario, aciertos, errores, tiempo, puntos, nivel, dificultad, fecha) " +
            "VALUES (" + num + ","+ idSesion + "," + ejercicio +", '" + idSesion + "'," + correctos + "," + 
