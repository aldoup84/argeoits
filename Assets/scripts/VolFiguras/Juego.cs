...
{
    Text txtCorrectos, txtBase, txtAltura, txtErrores, txtTarget, txtTiempo2, txtAyudas, txtNivel, txtFind, lblInfo, txtStatus, lblObjetivo, txtId;
	...
	public void Save() {
		...
		string dif = GetDificultad(niv);
		Debug.Log("Level:  " + niv + "	Dificultad: " + dif);
		GuardarDatos g = new GuardarDatos("1", idSesion, correctos, errores, pto, tiempo, niv, dif);
		g.Insert();		
	}
